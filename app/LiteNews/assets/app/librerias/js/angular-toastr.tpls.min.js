!function () {
    ...
    function t(t, e, s, n, o, r, a) {
        function i(t) {
            if (1 !== arguments.length || t)if (t)g(t.toastId); else for (var e = 0; e < O.length; e++)g(O[e].toastId)
        }
        ...
        function g(e, s) {
            ...
            i && !i.deleting && (i.deleting = !0, i.isOpened = !1, t.leave(i.el).then(function () {
                ...
                var t = O.indexOf(i);
                delete T[i.scope.message], O.splice(t, 1);
                var e = r.maxOpened;
                e && O.length >= e && O[e - 1].open.resolve(), o() && (h.remove(), h = null, B = a.defer())
            }))
        }
        ...
        function v(s) {
            function r() {
                return d.autoDismiss && d.maxOpened && O.length > d.maxOpened
            }
            ...
            function l() {
                ...
                return e.iconClass = s.iconClass, s.optionsOverride && (angular.extend(d, t(s.optionsOverride)), e.iconClass = s.optionsOverride.iconClass || e.iconClass), i(e, s, d), e.el = c(e.scope), e
            }
            ...
            function u() {
                return d.maxOpened && O.length <= d.maxOpened || !d.maxOpened
            }

            function p() {
                var t = d.preventDuplicates && s.message === w, e = d.preventOpenDuplicates && T[s.message];
                return t || e ? !0 : (w = s.message, T[s.message] = !0, !1)
            }

            var d = m();
            if (!p()) {
                var v = l();
                if (O.push(v), r())for (var B = O.slice(0, O.length - d.maxOpened), x = 0, $ = B.length; $ > x; x++)g(B[x].toastId);
                return u() && v.open.resolve(), v.open.promise.then(function () {
                    f(d).then(function () {
                        if (v.isOpened = !0, d.newestOnTop)t.enter(v.el, h).then(function () {
                            v.scope.init()
                        }); else {
                            var e = h[0].lastChild ? angular.element(h[0].lastChild) : null;
                            t.enter(v.el, h, e).then(function () {
                                v.scope.init()
                            })
                        }
                    })
    ...
    function t(t, e, s, n) {
        function o(s, o, r, a) {
            ...
            if (s.toastClass = s.options.toastClass, s.titleClass = s.options.titleClass, s.messageClass = s.options.messageClass, s.progressBar = s.options.progressBar, c()) {
                ...
                p.addClass("toast-close-button"), p.attr("ng-click", "close(true, $event)"), g(p)(s), o.prepend(p)
            }
            s.init = function () {
